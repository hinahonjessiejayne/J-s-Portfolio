...
export const PERSONAL_INFO = {
  ...
  about: "Your business shouldn't stop running just because you’ve logged off. As a Technical VA specializing NO-CODE AUTOMATION in High-Level (GHL), N8N, Zapier and Make.com. I build the \"backend engine\" that powers your sales and marketing. I combine technical precision with a proactive mindset. If there is a manual process slowing down your revenue, I automate it.",
